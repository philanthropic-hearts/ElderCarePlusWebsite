          ...
          <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
            ...
            <div class="carousel-caption">
              <div class="inner_carousel">
                ...
                <div class="more-btn">
                  <a class="view-more" href="<?php echo esc_url(get_permalink()); ?>"><?php esc_html_e( 'READ MORE', 'vw-medical-care' ); ?><i class="<?php echo esc_html(get_theme_mod('vw_medical_care_slider_button_icon','fa fa-angle-right')); ?>"></i><span class="screen-reader-text"><?php esc_html_e( 'READ MORE','vw-medical-care' );?></span></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-4 p-0">
            <div class="info">
              <?php if( get_theme_mod( 'vw_medical_care_call_text') != '' || get_theme_mod( 'vw_medical_care_call') != '') { ?>
                <i class="<?php echo esc_html(get_theme_mod('vw_medical_care_phone_icon','fas fa-phone')); ?>"></i><span><?php echo esc_html(get_theme_mod('vw_medical_care_call_text',''));?></span>
                <hr>
          ...
          <div class="col-lg-4 col-md-4 p-0 loc-box">
            <div class="location">
              <?php if( get_theme_mod( 'vw_medical_care_address_text') != '' || get_theme_mod( 'vw_medical_care_address') != '') { ?>
                <i class="<?php echo esc_html(get_theme_mod('vw_medical_care_location_icon','fas fa-map-marker-alt')); ?>"></i><br>
          ...
          <div class="col-lg-4 col-md-4 p-0">
            <div class="info">
              <?php if( get_theme_mod( 'vw_medical_care_email_text') != '' || get_theme_mod( 'vw_medical_care_email') != '') { ?>
                <i class="<?php echo esc_html(get_theme_mod('vw_medical_care_email_address_icon','fas fa-envelope-open')); ?>"></i><span><?php echo esc_html(get_theme_mod('vw_medical_care_email_text',''));?></span>
                <hr>
